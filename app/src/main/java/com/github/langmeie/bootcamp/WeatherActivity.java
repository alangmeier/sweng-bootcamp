...
import com.github.langmeie.bootcamp.geocoding.Address;
import com.github.langmeie.bootcamp.geocoding.AndroidGeocodingService;
import com.github.langmeie.bootcamp.geocoding.GeocodingService;
import com.github.langmeie.bootcamp.location.AndroidLocationService;
import com.github.langmeie.bootcamp.location.Location;
import com.github.langmeie.bootcamp.location.LocationService;
import com.github.langmeie.bootcamp.weather.OpenWeatherMapWeatherService;
import com.github.langmeie.bootcamp.weather.WeatherForecast;
import com.github.langmeie.bootcamp.weather.WeatherReport;
import com.github.langmeie.bootcamp.weather.WeatherService;
import com.google.android.material.tabs.TabLayout;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    private void displayForecast() {
        ...
        mWeatherMinTemperatureTextView.setText(String.format("%.1f", currentReport.minT));
        mWeatherAvgTemperatureTextView.setText(String.format("%.1f", currentReport.aveT));
        mWeatherMaxTemperatureTextView.setText(String.format("%.1f", currentReport.maxT));
    }
